...
exports.addCommand = (program, config, admin) => {
  ...
  .description('Gets firestore documents with an optional docSet.  If docSetId is not specified, includes documents in root collections. The specified docSetId must be defined in config.')
